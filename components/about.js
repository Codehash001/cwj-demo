...
function About() {
  return (
    <div className='h-auto'>
             ...
             <div className='px-6 py-4 border bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l flex items-center'>
        ...
        <div className='w-full h-full flex-flex-col items-center px-16 pt-8'>
           ...
           <div className='flex flex-row items-start mb-5'>
            ...
            <h1 className='font-Archivo text-5xl text-center font-semibold my-16 bg-gradient-to-r from-orange-500 to-red-700 bg-clip-text text-transparent'>Welcome to Cafe ParadiseBean!</h1>
