...
function About() {
  return (
    <div className='h-auto'>
             <div className='w-full h-[200px] bg-brand-01 flex flex-col items-center '>
             <h1 className='font-Archivo text-6xl text-center font-semibold mb-8 mt-6'>Welcome to Cafe ParadiseBean!</h1>
             </div>
        <div className='w-full h-full flex-flex-col items-center  px-16 pt-8'>
           
           <div className='flex flex-row items-start mb-5 mt-[-120px]'>
            <img src='/webimage1.png' className='w-[400px] h-auto rounded-lg'/>
            <div className='flex flex-col items-center ml-6'>
            <div className='px-6 py-3 rounded-md border bg-gray-200 flex items-center mt-4'>
              <h1 className='font-Kanit text-2xl text-black'>Join our Discord and get listed for free mint</h1>
              <a href=''>
              <button className='text-2xl font-Archivo text-black px-4 py-2 border border-black rounded-full'>Join Now</button>
              </a>
            </div>
