...
<Slider {...settings}>
        ...
        <span class="w-[1000px] h-[1000px] rounded-full rotate-[-40deg] bg-gradient-to-r from-orange-500 to-red-700 absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-2"></span>
