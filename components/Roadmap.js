...
function Roadmap() {
  ...
  return (
    ...
    <div className='w-screen h-full px-16 flex flex-col items-center'>
        ...
        {/* slider */}
<Slider {...settings}>
        <div className='h-[400px] p-6 flex flex-col items-center bg-gray-800 rounded-lg'>
        ...
        <div className='p-6 flex flex-col items-center bg-gray-800 rounded-lg'>
          <h1 className='text-xl font-semibold text-brand-01 mb-2'>Phase six</h1>
        ...
        <div className='p-6 flex flex-col items-center bg-gray-800 rounded-lg'>
          <h1 className='text-xl font-semibold text-brand-01 mb-2'>Phase seven</h1>
